...
\begin{figure}[H]
	\centering
	\includegraphics[width=14.5cm]{transform_templates_to_embeddings.pdf}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=5cm]{change_log_event.pdf}
