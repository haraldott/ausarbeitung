...
\begin{figure*}[ht!]
   \subfloat[5\% alteration\label{fig:results_delete_lines_multiclass_5}]{%
      \includegraphics[width=0.45\textwidth]{results/classification_sequence/multiclass_delete_lines_anomaly_ratio_0.05.png}}
\hspace{\fill}
   \subfloat[10\% alteration\label{fig:results_delete_lines_multiclass_10} ]{%
      \includegraphics[width=0.45\textwidth]{results/classification_sequence/multiclass_delete_lines_anomaly_ratio_0.10.png}}
\hspace{\fill}
\centering 
   \subfloat[15\% alteration\label{fig:results_delete_lines_multiclass_15}]{%
      \includegraphics[width=0.45\textwidth]{results/classification_sequence/multiclass_delete_lines_anomaly_ratio_0.15.png}}\\
\caption{\label{appendix:fig:results_delete_lines_regression}Delete lines at different ratios using, regression.}
\end{figure*}
